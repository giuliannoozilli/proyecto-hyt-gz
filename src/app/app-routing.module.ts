...
const routes: Routes = [
  ...
  },
  {
    path: 'about',
    loadChildren: () =>
      import('./pages/acercadenosotros/acercadenosotros.module').then(
        (m) => m.AcercadenosotrosModule
      ),
  },
  {
    path: 'contacto',
  ...
  },
  {
    path: 'casosdeexito',
    loadChildren: () =>
      import('./pages/casosdeexito/casosdeexito.module').then(
        (m) => m.CasosdeexitoModule
      ),
  },
];
